' ---------------------------------------------------------------------------------
' Enviar NFSe padr�o Betha (Munic�pio de Itapema-SC)
' ---------------------------------------------------------------------------------
Dim oConfiguracao
Dim xmlNfse
...
' Criar o objeto de configura��o m�nima para envio da NFSe
  ...
  oConfiguracao.TipoAmbiente = 2 ' Homologa��o
  oConfiguracao.CodigoMunicipio = 4208302 ' C�digo do IBGE de Itapema-SC
...
' Consumir o servi�o de consulta nfse por RPS        

' Criar objeto de configura��es m�nimas
  ...
  oConfigConsulta.TipoAmbiente =  2 ' Homologa��o
  oConfigConsulta.CodigoMunicipio = 4208302 ' C�digo do IBGE de Itapema-SC
