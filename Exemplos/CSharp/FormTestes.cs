...
using ServicoCCG = Uni.Business.DFe.Servicos.CCG;
using ServicoCTe = Uni.Business.DFe.Servicos.CTe;
using ServicoCTeOS = Uni.Business.DFe.Servicos.CTeOS;
using ServicoGNRe = Uni.Business.DFe.Servicos.GNRE;
using ServicoMDFe = Uni.Business.DFe.Servicos.MDFe;
using ServicoNFCe = Uni.Business.DFe.Servicos.NFCe;
using ServicoNFe = Uni.Business.DFe.Servicos.NFe;
using ServicoNFSe = Uni.Business.DFe.Servicos.NFSe;
using XmlCCG = Uni.Business.DFe.Xml.CCG;
using XmlCTe = Uni.Business.DFe.Xml.CTe;
using XmlCTeOS = Uni.Business.DFe.Xml.CTeOS;
using XmlGNRe = Uni.Business.DFe.Xml.GNRE;
using XmlMDFe = Uni.Business.DFe.Xml.MDFe;
using XmlNFe = Uni.Business.DFe.Xml.NFe;
...
namespace TreinamentoDLL
{
    public partial class FormTestes : Form
    {
        ...
        {
            var xml = new Uni.Business.DFe.Xml.MDFe.ConsSitMDFe
            {
                Versao = "3.00",
            ...
            var consultaProtocolo = new Uni.Business.DFe.Servicos.MDFe.ConsultaProtocolo(xml, configuracao);
        ...
        {
            var xml = new Uni.Business.DFe.Xml.MDFe.ConsStatServMDFe
            {
                Versao = "3.00",
                TpAmb = TipoAmbiente.Homologacao
            };
            ...
            var statusServico = new Uni.Business.DFe.Servicos.MDFe.StatusServico(xml, configuracao);
        ...
        {
            var xml = new Uni.Business.DFe.Xml.MDFe.EnviMDFe
            {
                Versao = "3.00",
                IdLote = "000000000000001",
                MDFe = new Uni.Business.DFe.Xml.MDFe.MDFe
                {
                    InfMDFe = new Uni.Business.DFe.Xml.MDFe.InfMDFe
                    {
                        Versao = "3.00",
                        Ide = new Uni.Business.DFe.Xml.MDFe.Ide
                        {
                            CUF = UFBrasil.PR,
                            TpAmb = TipoAmbiente.Homologacao,
                            ...
                            UFIni = UFBrasil.PR,
                            UFFim = UFBrasil.SP,
                            InfMunCarrega = new List<Uni.Business.DFe.Xml.MDFe.InfMunCarrega>
                            {
                                new Uni.Business.DFe.Xml.MDFe.InfMunCarrega
                                {
                                    CMunCarrega = 4118402,
                        ...
                        Emit = new Uni.Business.DFe.Xml.MDFe.Emit
                        {
                            CNPJ = "31905001000109",
                            IE = "9079649730",
                            XNome = "EXATUS MOVEIS EIRELI",
                            XFant = "EXATUS MOVEIS",
                            EnderEmit = new Uni.Business.DFe.Xml.MDFe.EnderEmit
                            {
                        ...
                        InfModal = new Uni.Business.DFe.Xml.MDFe.InfModal
                        {
                            VersaoModal = "3.00",
                            Rodo = new Uni.Business.DFe.Xml.MDFe.Rodo
                            {
                                InfANTT = new Uni.Business.DFe.Xml.MDFe.InfANTT
                                {
                                    RNTRC = "44957333",
                                    InfContratante = new List<Uni.Business.DFe.Xml.MDFe.InfContratante>
                                    {
                                        new Uni.Business.DFe.Xml.MDFe.InfContratante
                                        {
                                            CNPJ = "80568835000181"
                                        },
                                        new Uni.Business.DFe.Xml.MDFe.InfContratante
                                ...
                                VeicTracao = new Uni.Business.DFe.Xml.MDFe.VeicTracao
                                {
                                    CInt = "AXF8500",
                                    Placa = "AXF8500",
                                    Tara = 0,
                                    CapKG = 5000,
                                    Prop = new Uni.Business.DFe.Xml.MDFe.Prop
                                    {
                                        CNPJ = "31905001000109",
                                        RNTRC = "44957333",
                                        XNome = "EXATUS MOVEIS EIRELI",
                                    ...
                                    Condutor = new List<Uni.Business.DFe.Xml.MDFe.Condutor>
                                    {
                                        new Uni.Business.DFe.Xml.MDFe.Condutor
                                        {
                        ...
                        InfDoc = new Uni.Business.DFe.Xml.MDFe.InfDocInfMDFe
                        {
                            InfMunDescarga = new List<Uni.Business.DFe.Xml.MDFe.InfMunDescarga>
                            {
                                new Uni.Business.DFe.Xml.MDFe.InfMunDescarga
                                {
                                    CMunDescarga = 3505708,
                                    XMunDescarga = "BARUERI",
                                    InfCTe = new List<Uni.Business.DFe.Xml.MDFe.InfMunDescargaInfCTe>
                                    {
                                        new Uni.Business.DFe.Xml.MDFe.InfMunDescargaInfCTe
                                        {
                                    ...
                                    InfNFe = new List<Uni.Business.DFe.Xml.MDFe.InfMunDescargaInfNFe>
                                    {
                                        new Uni.Business.DFe.Xml.MDFe.InfMunDescargaInfNFe
                                        {
                                            ChNFe = "12345678901234567890123456789012345678901234",
                                            InfUnidTransp = new List<Uni.Business.DFe.Xml.MDFe.InfUnidTransp>
                                            {
                                                new Uni.Business.DFe.Xml.MDFe.InfUnidTransp
                                                {
                                                    IdUnidTransp = "122",
                                                    TpUnidTransp = TipoUnidadeTransporte.RodoviarioReboque,
                                                    LacUnidTransp = new List<Uni.Business.DFe.Xml.MDFe.LacUnidTransp>
                                                    {
                                                        new Uni.Business.DFe.Xml.MDFe.LacUnidTransp
                                                        {
                                                            NLacre = "12334"
                                                        }
                                                    },
                                                    InfUnidCarga = new List<Uni.Business.DFe.Xml.MDFe.InfUnidCarga>
                                                    {
                                                        new Uni.Business.DFe.Xml.MDFe.InfUnidCarga
                                                        {
                                                            TpUnidCarga = TipoUnidadeCarga.Container,
                                                            IdUnidCarga = "123",
                                                            LacUnidCarga = new List<Uni.Business.DFe.Xml.MDFe.LacUnidCarga>
                                                            {
                                                                new Uni.Business.DFe.Xml.MDFe.LacUnidCarga
                                                                {
                                                                    NLacre = "3333333"
                                                                }
                                                            }
                        ...
                        ProdPred = new Uni.Business.DFe.Xml.MDFe.ProdPred
                        {
                            TpCarga = TipoCargaMDFe.CargaGeral,
                            XProd = "TESTE DE PRODUTO PREDOMINANTE",
                            InfLotacao = new Uni.Business.DFe.Xml.MDFe.InfLotacao
                            {
                                InfLocalCarrega = new Uni.Business.DFe.Xml.MDFe.InfLocalCarrega
                                {
                                    CEP = "87302080"
                                },
                                InfLocalDescarrega = new Uni.Business.DFe.Xml.MDFe.InfLocalDescarrega
                                {
                                    CEP = "25650208"
                                }
                            }
                        },
                        Seg = new List<Uni.Business.DFe.Xml.MDFe.Seg>
                        {
                            new Uni.Business.DFe.Xml.MDFe.Seg
                            {
                                InfResp = new Uni.Business.DFe.Xml.MDFe.InfResp
                                {
                                    RespSeg = ResponsavelSeguroMDFe.EmitenteMDFe,
                                    CNPJ = "31905001000109"
                                },
                                InfSeg = new Uni.Business.DFe.Xml.MDFe.InfSeg
                                {
                                    XSeg = "PORTO SEGURO",
                                    CNPJ = "61198164000160"
                                },
                        ...
                        Tot = new Uni.Business.DFe.Xml.MDFe.Tot
                        {
                            QCTe = 3,
                            VCarga = 56599.09,
                        ...
                        Lacres = new List<Uni.Business.DFe.Xml.MDFe.Lacre>
                        {
                            new Uni.Business.DFe.Xml.MDFe.Lacre
                            {
                                NLacre = "1111111"
                            },
                            new Uni.Business.DFe.Xml.MDFe.Lacre
                        ...
                        InfAdic = new Uni.Business.DFe.Xml.MDFe.InfAdic
                        {
                            InfCpl = "DATA/HORA PREVISTA PARA O INICO DA VIAGEM: 10/08/2020 as 08:00"
                        },
                        InfRespTec = new Uni.Business.DFe.Xml.MDFe.InfRespTec
                        {
                            CNPJ = "06117473000150",
            ...
            var autorizacao = new Uni.Business.DFe.Servicos.MDFe.Autorizacao(xml, configuracao);
            ...
            if (autorizacao.Result != null)
            {
                ...
                {
                    var xmlRec = new Uni.Business.DFe.Xml.MDFe.ConsReciMDFe
                    {
                        Versao = "3.00",
                        TpAmb = TipoAmbiente.Homologacao,
                    ...
                    var retAutorizacao = new Uni.Business.DFe.Servicos.MDFe.RetAutorizacao(xmlRec, configRec);
                    ...
                    var xmlSit = new Uni.Business.DFe.Xml.MDFe.ConsSitMDFe
                    {
                        Versao = "3.00",
                        TpAmb = TipoAmbiente.Homologacao,
                    ...
                    var consultaProtocolo = new Uni.Business.DFe.Servicos.MDFe.ConsultaProtocolo(xmlSit, configSit);
                    consultaProtocolo.Executar();
        ...
        private void BtnCarregarA3comPIN_Click(object sender, EventArgs e)
        {
            ...
            //Para funcionar o método IsA3 e SetPinPrivateKey, abaixo, tem que dar o using no name space a seguir "using Uni.Business.DFe.Security" 
