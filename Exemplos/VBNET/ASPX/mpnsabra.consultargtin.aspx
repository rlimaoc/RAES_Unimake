...
Configuracao.TipoDFe = 10
            ...
            Dim consGTIN = New Uni.Business.DFe.Xml.CCG.ConsGTIN
               ...
               metext.text =  "Erro na Execução : " & Chr(10) & Chr(10) & ex.ToString
              
                Exit Sub
            End Try
            Dim Mensa as string = ConsultaGTIN.RetornoWSString & Chr(10) & Chr(10)
	        Metext.text = ConsultaGTIN.Result.CStat & " - " & ConsultaGTIN.Result.XMotivo
            Metext1.text = "Gtin : " & ConsultaGTIN.Result.GTIN & "   Tipo GTIN : " &  ConsultaGTIN.Result.tpGTIN
            Metext2.text = "Descricao : " & ConsultaGTIN.Result.xProd
            Metext3.text = "NCM : " & ConsultaGTIN.Result.NCM
            Exit Sub	
