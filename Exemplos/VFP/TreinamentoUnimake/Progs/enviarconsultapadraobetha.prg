* ---------------------------------------------------------------------------------
* Enviar consultas diversas de NFSe padr�o BETHA (Munic�pio de Itapema-SC)
* ---------------------------------------------------------------------------------
FUNCTION EnviarConsultaPadraoBETHA()
    ...
    * Consumir o servi�o de consulta
      ...
      oConfiguracao.TipoAmbiente =  2 && Produ��o
    ...
    * -------------------------------------------------------------   
    * Consulta de NFSe�s Emitidas por per�odo (Servicos prestados)
    * -------------------------------------------------------------
    * Criar o XML
      xmlConsulta = ""
      xmlConsulta = xmlConsulta + AllTrim([<?xml version="1.0" encoding="utf-8"?>])
   ...
   * Consumir o servi�o de consulta
    ...
    * -------------------------------------------------------------
    * Consulta de NFSe�s Recebidas por per�odo (Servi�os tomados)
    * -------------------------------------------------------------
    * Criar o XML
      xmlConsulta = ""
