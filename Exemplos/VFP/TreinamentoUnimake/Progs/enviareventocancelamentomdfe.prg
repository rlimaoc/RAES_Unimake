 ...
 * Criar tag DetEventoCanc
   oDetEventoCanc = CREATEOBJECT("Uni.Business.DFe.Xml.MDFe.DetEventoCanc")
 ...
 * Criar objeto para pegar exce��o do lado do CSHARP
    ...
    * Gravar o XML assinado no HD.
      ...
      IF oRecepcaoEvento.Result.InfEvento.CStat == 135 && Recebido pelo Sistema de Registro de Eventos, com vincula��o do evento no respetivo MDFe
         oRecepcaoEvento.GravarXmlDistribuicao("d:\testenfe") &&Gravar o XML de distribui��o na pasta informada
      ELSE
