* ---------------------------------------------------------------------------------
* Gerar XML da NFe e enviar no modo s�ncrono finalizando a nota via consulta 
...
* -- 4 - XML de distribui��o arquivado
* -- 5 - Processo de envio conclu�do com sucesso
 ...
 * Criar objeto para pegar excecao do lado do CSHARP
   ...
   Try
       ...
       * Codigo de Status e Motivo
         ...
         nStatusEnvio = 3 && Retorno recebido e dados importantes arquivados
