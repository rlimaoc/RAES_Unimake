 ...
 * IMPORTANTE: Atualiza��o da propriedade TpEvento deve acontecer depois que o DetEvento recebeu o oDetEventoEPEC para que funcione sem erro
    ...
    * Gravar o XML assinado no HD, antes de enviar.
       ...
       * � necess�rio fazer um loop para ver a autoriza��o de cada um deles
         For I = 1 To oRecepcaoEvento.Result.GetRetEventoCount()
             ...
             IF oRetEvento.InfEvento.CStat = 136 && Evento homologado sem vincula��o com a respectiva NFe (SEFAZ n�o encontrou a NFe na base dela)
                oRecepcaoEvento.GravarXmlDistribuicao("d:\testenfe\epec") && Grava o XML de distribui��o

              * Criar as configura��es para imprimir o DANFE
