* ---------------------------------------------------------------------------------
* Enviar consultas diversas de NFSe padr�o Paulistana (Munic�pio de S�o Paulo)
* ---------------------------------------------------------------------------------
FUNCTION EnviarConsultaPadraoPAULISTANA()
    ...
    * ------------------------------------------------------   
    * Consulta de NFSe�s Emitidas por per�odo
    * ------------------------------------------------------
    * Criar o XML
      xmlConsulta = ""
      xmlConsulta = xmlConsulta + AllTrim([<?xml version="1.0" encoding="utf-8"?>])
   ...
   * Consumir o servi�o de consulta
    ...
    * ------------------------------------------------------   
    * Consulta de NFSe�s Recebidas por per�odo
    * ------------------------------------------------------
    * Criar o XML
      xmlConsulta = ""
      xmlConsulta = xmlConsulta + AllTrim([<?xml version="1.0" encoding="utf-8"?>])
