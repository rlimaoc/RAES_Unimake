* ---------------------------------------------------------------------------------
* Enviar NFSe padr�o Paulistana (Munic�pio de S�o Paulo)
* ---------------------------------------------------------------------------------
 ...
 * Criar o objeto de configura��o m�nima
   ...
   oConfiguracao.TipoAmbiente = 1 && Produ��o
   
   oConfiguracao.CodigoMunicipio = 3550308 && C�digo do IBGE de S�o Paulo-SP
 ...
 * Criar objeto para pegar exce��o do lado do CSHARP
    ...
    * Consumir o servi�o de consulta nfse por RPS        
      ...
      oConfigConsulta.TipoAmbiente =  1 && Produ��o
      oConfigConsulta.CodigoMunicipio = 3550308 && C�digo do IBGE de S�o Paulo-SP
