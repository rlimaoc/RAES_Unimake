* ---------------------------------------------------------------------------------
* Enviar CTe de forma s�ncrona
* ---------------------------------------------------------------------------------
FUNCTION EnviarCTeSincronoSVC()
 ...
 * Criar o objeto de configura��o m�nima
   ...
   oConfiguracao.TipoEmissao = 7 && 7=SVCRS 8=SVCSP
 ...
 * Criar objeto para pegar exce��o do lado do CSHARP
   ...
   TRY
    * Criar o objeto para consumir o servi�o de autoriza��o do CTe
    ...
    * O conte�do do XML assinado deve ser gravado na base de dados para ser recuperado 
    * caso seja necess�rio. Imagine que de um problema no envio do CTe e vc precise resgatar para enviar novamente.
    ...
    * Demonstrar o XML retornado pela SEFAZ
	  ...
	  If .NOT. ISNULL(oAutorizacaoSinc.Result)
         ...
         If oAutorizacaoSinc.Result.CStat == 104 && Lote processado
             ...
             * Gravar o XML de distribui��o do CTe no HD, se preferir assim.
  	           oAutorizacaoSinc.GravarXmlDistribuicao("d:\testenfe")
			 
			 * Pegar a string do XML de distribui��o para gravar na base de dados, se preferir assim.  
