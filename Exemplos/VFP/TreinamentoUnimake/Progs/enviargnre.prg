 ...
 * Criar grupo de tag Identificacao  
   ...
   oContribuinteEmitente.Identificacao = oIdentificacao && Atualizar conte�do do grupo de tag identificacao
   ...
   oTDadosGNRE.ContribuinteEmitente = oContribuinteEmitente && Atualizar conte�do do grupo de tag ContribuinteEmitente   
 ...
 * Criar grupo de tag Valor
   ...
   oItem.AddValor(oValor) && Atualizar conte�do do grupo de tag Valor
   
   oItensGNRE.AddItem(oItem) && Atualizar conte�do do grupo de tag Item
   
   oTDadosGNRE.ItensGNRE = oItensGNRE && Atualizar conteudo do grupo de tag ItensGNRE
    
   oGuias.AddTDadosGNRE(oTDadosGNRE) && Atualizar conte�do do grupo de tag TDadosGNRE

   oTLoteGNRE.Guias = oGuias && Atualizar o conte�do do grupo de tag Guias
 ...
 * Criar objeto para pegar exce��o do lado do CSHARP
   ...
   TRY
       ...
       * Aguardar 30 segundos para consultar o resultado do lote, � o que solicita o manual
         
       * Criar configura�ao b�sica para consumir o servi�o de consulta do resultado do envio da GNRE
       ...
       * Criar o XML da consulta
         ...
         DO CASE
            ...
            CASE oConsultaResultadoLote.Result.SituacaoProcess.Codigo = "403" && Lote processado com pend�ncias ou Lote com pend�ncia de tempo de processamento. As Guias com situa��o 4 (campo < situacaoGuia > para a vers�o 2.00) podem levar em m�dia 20 minutos, e no m�ximo 1 hora para serem processadas.
                 * Analisar pendencias
