 ...
 * Criar objeto para pegar exce��o do lado do CSHARP
    ...
    * Criar o objeto para consumir o servi�o de autoriza��o do MDFe
      oAutorizacaoSinc = CREATEOBJECT("Uni.Business.DFe.Servicos.MDFe.AutorizacaoSinc")
    ...
    * caso seja necess�rio. Imagine que de um problema no envio do MDFe e vc precise resgatar para enviar novamente.
    ...
    * Demonstrar o XML retornado pela SEFAZ
	  ...
	  If .NOT. ISNULL(oAutorizacaoSinc.Result)
         ...
         If oAutorizacaoSinc.Result.CStat == 104 && Lote processado
             ...
             * Gravar o XML de distribui��o do MDFe no HD, se preferir assim.
