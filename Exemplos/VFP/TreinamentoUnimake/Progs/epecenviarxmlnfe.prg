 ...
 * Criar a tag <NFe>  
   ...
   TRY 
   * Criar o objeto para consumir o servi�o, mas vamos somente pegar o XML e n�o vamos enviar
     oAutorizacao = CreateObject("Uni.Business.DFe.Servicos.NFe.Autorizacao")
     oAutorizacao.SetXMLConfiguracao(oEnviNFe, oConfig)
     
   * Guardar o XML da NFe j� assinada para transmitirmos sem mudar nada depois que o servi�o voltar ao normal.
   * XML tem que ser guardado e este que deve ser transmitido para evitar diferen�as entre a NFe ou CTe e o evento de EPEC
