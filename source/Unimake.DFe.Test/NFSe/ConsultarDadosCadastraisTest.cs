...
namespace Unimake.DFe.Test.NFSe
{
    ...
    /// </summary>
    public class ConsultarDadosCadastraisTest
    {
        /// <summary>
        /// Monta o parâmetros, de forma dinâmica, para o cenário de testes
        /// </summary>
        public static IEnumerable<object[]> Parametros => TestUtility.PreparaDadosCenario("ConsultarDadosCadastrais");
        ...
        public void ConsultarDadosCadastrais(TipoAmbiente tipoAmbiente, PadraoNFSe padraoNFSe, string versaoSchema, int codMunicipio)
        {
            ...
            var configuracao = new Configuracao
            {
                ...
                Servico = Servico.NFSeConsultarDadosCadastrais,
