...
{
    /// <summary>
    /// Testar o serviço: ConsultaLote
    /// </summary>
    public class ObterCriticaLoteTest
    {
        /// <summary>
        /// Monta o parâmetros, de forma dinâmica, para o cenário de testes
        /// </summary>
        public static IEnumerable<object[]> Parametros => TestUtility.PreparaDadosCenario("ObterCriticaLote");

        /// <summary>
        /// Consulta Lote para saber se a conexão com o webservice está ocorrendo corretamente.
        /// </summary>
        /// <param name="tipoAmbiente">Ambiente para onde deve ser enviado o XML</param>
        [Theory]
        [Trait("DFe", "NFSe")]
        [MemberData(nameof(Parametros))]
        public void ObterCriticaLote(TipoAmbiente tipoAmbiente, PadraoNFSe padraoNFSe, string versaoSchema, int codMunicipio)
        {
            var nomeXMLEnvio = "oberCriticaLote-ped-sitloterps.xml";
            ...
            var configuracao = new Configuracao
            {
                ...
                Servico = Servico.NFSeObterCriticaLote,
            ...
            var obterCriticaLote = new ObterCriticaLote(conteudoXML, configuracao);
