...
namespace Unimake.DFe.Test.NFSe
{
    ...
    /// </summary>
    public class ConsultarUrlNfseTest
    {
        /// <summary>
        /// Monta o parâmetros, de forma dinâmica, para o cenário de testes
        /// </summary>
        public static IEnumerable<object[]> Parametros => TestUtility.PreparaDadosCenario("ConsultarUrlNfse");
        ...
        public void ConsultarUrlNfse(TipoAmbiente tipoAmbiente, PadraoNFSe padraoNFSe, string versaoSchema, int codMunicipio)
        {
            var nomeXMLEnvio = "ConsultarUrlNfseEnvio-ped-urlnfse.xml";
            ...
            var configuracao = new Configuracao
            {
                ...
                Servico = Servico.NFSeConsultarUrlNfse,
            ...
            var consultarUrlNfse = new ConsultarUrlNfse(conteudoXML, configuracao);
