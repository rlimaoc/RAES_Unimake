...
{
    /// <summary>
    /// Testar o serviço: EnvioLoteRps
    /// </summary>
    public class EnvioLoteRpsTest
    {
        /// <summary>
        /// Monta o parâmetros, de forma dinâmica, para o cenário de testes
        /// </summary>
        public static IEnumerable<object[]> Parametros => TestUtility.PreparaDadosCenario("EnvioLoteRps");

        /// <summary>
        /// Envio Lote Rps para saber se a conexão com o webservice está ocorrendo corretamente.
        /// </summary>
