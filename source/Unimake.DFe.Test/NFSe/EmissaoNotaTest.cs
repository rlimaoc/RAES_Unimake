...
{
    /// <summary>
    /// Testar o serviço: EmissaoNota
    /// </summary>
    public class EmissaoNotaTest
    {
        /// <summary>
        /// Monta o parâmetros, de forma dinâmica, para o cenário de testes
        /// </summary>
        public static IEnumerable<object[]> Parametros => TestUtility.PreparaDadosCenario("EmissaoNota");

        /// <summary>
        /// Emissão NFse para saber se a conexão com o webservice está ocorrendo corretamente.
        /// </summary>
        /// <param name="tipoAmbiente">Ambiente para onde deve ser enviado o XML</param>
        [Theory]
        [Trait("DFe", "NFSe")]
        [MemberData(nameof(Parametros))]
        public void EmissaoNota(TipoAmbiente tipoAmbiente, PadraoNFSe padraoNFSe, string versaoSchema, int codMunicipio)
        {
            var nomeXMLEnvio = "EmissaoNota-env-loterps.xml";
            ...
            var configuracao = new Configuracao
            {
                ...
                TokenSoap = "BRU3COQJ2A2K6Q8NV3IMDVGYQTEW2HO7", //Tem município que exige token no envio do soap, então já vamos deixar algo definido para que utilize nos padrões necessários durante o teste unitário.
            ...
            var emissaoNota = new EmissaoNota(conteudoXML, configuracao);
