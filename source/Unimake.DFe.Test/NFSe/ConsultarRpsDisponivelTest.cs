...
namespace Unimake.DFe.Test.NFSe
{
    ...
    /// </summary>
    public class ConsultarRpsDisponivelTest
    {
        /// <summary>
        /// Monta o parâmetros, de forma dinâmica, para o cenário de testes
        /// </summary>
        public static IEnumerable<object[]> Parametros => TestUtility.PreparaDadosCenario("ConsultarRpsDisponivel");
        ...
        public void ConsultarRpsDisponivel(TipoAmbiente tipoAmbiente, PadraoNFSe padraoNFSe, string versaoSchema, int codMunicipio)
        {
            var nomeXMLEnvio = "ConsultarRpsDisponivelEnvio-ped-consrpsdisp.xml";
            ...
            var configuracao = new Configuracao
            {
                ...
                Servico = Servico.NFSeConsultarRpsDisponivel,
