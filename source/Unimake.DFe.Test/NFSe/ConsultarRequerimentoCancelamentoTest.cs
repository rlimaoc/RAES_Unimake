...
namespace Unimake.DFe.Test.NFSe
{
    ...
    /// </summary>
    public class ConsultarRequerimentoCancelamentoTest
    {
        /// <summary>
        /// Monta o parâmetros, de forma dinâmica, para o cenário de testes
        /// </summary>
        public static IEnumerable<object[]> Parametros => TestUtility.PreparaDadosCenario("ConsultarRequerimentoCancelamento");
        ...
        public void ConsultarRequerimentoCancelamento(TipoAmbiente tipoAmbiente, PadraoNFSe padraoNFSe, string versaoSchema, int codMunicipio)
        {
            ...
            string arqXML = "..\\..\\..\\NFSe\\Resources\\" + padraoNFSe.ToString() + "\\" + versaoSchema + "\\" + nomeXMLEnvio;
            ...
            var configuracao = new Configuracao
            {
                ...
                Servico = Servico.NFSeConsultarRequerimentoCancelamento,
