...
{
    /// <summary>
    /// Testar o serviço: EnviarLoteNotasTest
    /// </summary>
    public class EnviarLoteNotasTest
    {
        /// <summary>
        /// Monta o parâmetros, de forma dinâmica, para o cenário de testes
        /// </summary>
        public static IEnumerable<object[]> Parametros => TestUtility.PreparaDadosCenario("EnviarLoteNotas");
        ...
        public void EnviarLoteNotas(TipoAmbiente tipoAmbiente, PadraoNFSe padraoNFSe, string versaoSchema, int codMunicipio)
        {
            var nomeXMLEnvio = "enviarLoteNotas-env-loterps.xml";
            ...
            var configuracao = new Configuracao
            {
                ...
                Servico = Servico.NFSeEnviarLoteNotas,
            ...
            var enviarLoteNotas = new EnviarLoteNotas(conteudoXML, configuracao);
