    ...
    public class ConsultaProtocoloTest
    {
        ...
        public void ConsultarProtocoloNFCom(UFBrasil ufBrasil, TipoAmbiente tipoAmbiente)
        {
            var xml = new ConsSitNFCom
            {
                Versao = "1.00",
                TpAmb = tipoAmbiente,
                //Chave qualquer somente para termos algum tipo de retorno para sabe se a conexão com a sefaz funcionou
                ChNFCom = ((int)ufBrasil).ToString() + "200106117473000150550010000606641403753210"
            };
            ...
            var configuracao = new Configuracao
            {
                ...
                WebEnderecoProducao = "https://nfcom.svrs.rs.gov.br/WS/NFComConsulta/NFComConsulta.asmx",
