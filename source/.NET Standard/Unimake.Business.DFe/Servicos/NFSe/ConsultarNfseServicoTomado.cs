...
{
    /// <summary>
    /// Enviar o XML de Consulta NFSe de Serviços Tomados para o webservice
    /// </summary>
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Unimake.Business.DFe.Servicos.NFSe.ConsultarNfseServicoTomado")]
    [ComVisible(true)]
#endif
    public class ConsultarNfseServicoTomado : ConsultarNfse
    {
        ...
        public ConsultarNfseServicoTomado(string conteudoXML, Configuracao configuracao) : this()
        {
