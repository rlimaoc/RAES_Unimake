...
namespace Uni.Business.DFe.Servicos.NFSe
{
    ...
    [ProgId("Uni.Business.DFe.Servicos.NFSe.ConsultarNfseServicoPrestado")]
    [ComVisible(true)]
#endif
    public class ConsultarNfseServicoPrestado: ConsultarNfse
    {
        ...
        public ConsultarNfseServicoPrestado(string conteudoXML, Configuracao configuracao) : this()
        {
