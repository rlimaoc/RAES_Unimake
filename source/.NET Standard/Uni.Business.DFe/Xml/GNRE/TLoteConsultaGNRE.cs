...
namespace Uni.Business.DFe.Xml.GNRE
{
    ...
    [ProgId("Uni.Business.DFe.Xml.GNRE.TLoteConsultaGNRE")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.GNRE.Consulta")]
    [ComVisible(true)]
#endif
    [Serializable()]
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.GNRE.EmitenteId")]
    [ComVisible(true)]
#endif
    [Serializable()]
    [XmlType(AnonymousType = true, Namespace = "http://www.gnre.pe.gov.br")]
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.GNRE.DocOrigem")]
    [ComVisible(true)]
#endif
    [Serializable()]
    [XmlType(AnonymousType = true, Namespace = "http://www.gnre.pe.gov.br")]
