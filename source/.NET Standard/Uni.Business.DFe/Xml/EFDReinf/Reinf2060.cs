...
namespace Uni.Business.DFe.Xml.EFDReinf
{
    ...
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.Reinf2060")]
    [ComVisible(true)]
#endif
    [Serializable()]
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.EvtCPRB")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.IdeEventoReinf2060")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.InfoCPRB")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.IdeEstabReinf2060")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.TipoCod")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.TipoAjuste")]
    [ComVisible(true)]
#endif
...
#if INTEROP
        [ClassInterface(ClassInterfaceType.AutoDual)]
        [ProgId("Uni.Business.DFe.Xml.EFDReinf.InfoProcReinf2060")]
        [ComVisible(true)]
#endif
