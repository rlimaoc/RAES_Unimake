...
namespace Uni.Business.DFe.Xml.EFDReinf
{
    ...
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.Reinf2055")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.EvtAqProd")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.IdeEventoReinf2055")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.InfoAquisProd")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.IdeEstabAdquir")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.IdeProdutor")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.DetAquis")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.InfoProcJud")]
    [ComVisible(true)]
#endif
