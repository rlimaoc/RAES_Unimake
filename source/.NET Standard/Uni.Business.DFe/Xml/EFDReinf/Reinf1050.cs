...
namespace Uni.Business.DFe.Xml.EFDReinf
{
    ...
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.Reinf1050")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.EvtTabLig")]
    [ComVisible(true)]
#endif
    [Serializable()]
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.InfoLig")]
    [ComVisible(true)]
#endif
    [Serializable()]
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.InclusaoReinf1050")]
    [ComVisible(true)]
#endif
    [Serializable()]
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.IdeEntLig")]
    [ComVisible(true)]
#endif
    [Serializable()]
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.AlteracaoReinf1050")]
    [ComVisible(true)]
#endif
    [Serializable()]
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.NovaValidade")]
    [ComVisible(true)]
#endif
    [Serializable()]
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.ExclusaoReinf1050")]
    [ComVisible(true)]
#endif
    [Serializable()]
