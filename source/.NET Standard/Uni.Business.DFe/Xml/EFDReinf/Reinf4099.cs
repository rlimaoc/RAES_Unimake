...
namespace Uni.Business.DFe.Xml.EFDReinf
{
    ...
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.Reinf4099")]
    [ComVisible(true)]
#endif
    [Serializable()]
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.EvtFech")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.IdeEventoReinf4099")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.IdeRespInfReinf4099")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.InfoFechReinf4099")]
    [ComVisible(true)]
#endif
