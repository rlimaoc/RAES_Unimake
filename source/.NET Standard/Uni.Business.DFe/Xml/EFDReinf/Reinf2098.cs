...
namespace Uni.Business.DFe.Xml.EFDReinf
{
    ...
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.Reinf2098")]
    [ComVisible(true)]
#endif
    [Serializable()]
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.EvtReabreEvPer")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.Business.DFe.Xml.EFDReinf.IdeEventoReinf2098")]
    [ComVisible(true)]
#endif
