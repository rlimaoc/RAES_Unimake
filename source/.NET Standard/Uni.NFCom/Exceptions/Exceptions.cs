...
namespace Uni.NFCom.Exceptions
{
    /// <summary>
    ...
    [ProgId("Uni.NFCom.Exceptions.CertificadoDigitalException")]
    [ComVisible(true)]
#endif
    ...
    public enum ErrorCodes
    {
        ...
        /// <summary>
        /// Erro de validação de diversas das regras dos documentos fiscais eletrônicos (NFCom). Validação realizada pelo Validator da DLL Uni.NFCom.
        /// </summary>
        ValidatorDFe = 3,
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Uni.NFCom.Exceptions.CarregarCertificadoException")]
    [ComVisible(true)]
#endif
