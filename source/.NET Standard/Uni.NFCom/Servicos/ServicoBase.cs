...
using System.Xml;
using System.IO;
using Uni.NFCom.Validator;
using Uni.NFCom.Utility;
using Uni.NFCom.Servicos.Enums;
using Uni.NFCom.Security;
using Uni.NFCom.ConsumirServico;

namespace Uni.NFCom.Servicos
{
    /// <summary>
    ...
    [ProgId("Uni.NFCom.Servicos.ServicoBase")]
    [ComVisible(true)]
#endif
    public abstract class ServicoBase
    {
        ...
        protected virtual void Inicializar(XmlDocument conteudoXML, Configuracao configuracao)
        {
            ...
            System.Diagnostics.Trace.WriteLine(ConteudoXML?.InnerXml, "Uni.NFCom");
        ...
        public virtual void Executar()
        {
            ...
            else
            {
                var soap = new WSSoap
                {
                    ...
                    MunicipioSenha = Configuracoes.MunicipioSenha, //Configuracoes.ConverteSenhaBase64 ? Configuracoes.MunicipioSenha.Base64Encode() : Configuracoes.MunicipioSenha,
                    MunicipioUsuario = Configuracoes.MunicipioUsuario,
                    Token = Configuracoes.MunicipioToken,
