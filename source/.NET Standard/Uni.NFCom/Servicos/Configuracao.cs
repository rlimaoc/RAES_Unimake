...
namespace Uni.NFCom.Servicos
{
    ...
    [ProgId("Uni.NFCom.Servicos.Configuracao")]
    [ComVisible(true)]
#endif
    public class Configuracao
    {
        ...
        public void Load(string nomeTagServico)
        {
            ...
            if (CodigoConfig != 0)
            {
                ...
                {
                    throw new Exception((CodigoConfig.ToString().Length <= 2 ? "Unidade Federativa" : "Município") + " (" + CodigoConfig + ") não está implementado na DLL Uni.NFCom. Entre em contato com o suporte para solicitar a implementação.");
                }
            }
        }
