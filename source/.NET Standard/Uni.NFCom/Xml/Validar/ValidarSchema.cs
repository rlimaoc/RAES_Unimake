...
namespace Uni.NFCom.Xml
{
    ...
    [ProgId("Uni.NFCom.ValidarSchema")]
    [ComVisible(true)]
#endif
    public class ValidarSchema
    {
        ...
        private IEnumerable<XmlSchema> ExtractSchemasResource(string arqSchema, PadraoNFSe padraoNFSe = PadraoNFSe.None)
        {
