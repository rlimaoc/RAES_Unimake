...
{
    /// <summary>
    /// Testar o serviço: TesteEnvioLoteRps
    /// </summary>
    public class TesteEnvioLoteRpsTest
    {
        /// <summary>
        /// Monta o parâmetros, de forma dinâmica, para o cenário de testes
        /// </summary>
        public static IEnumerable<object[]> Parametros => TestUtility.PreparaDadosCenario("TesteEnvioLoteRps");

        /// <summary>
        /// Teste Envio Lote Rps para saber se a conexão com o webservice está ocorrendo corretamente.
        /// </summary>
        /// <param name="tipoAmbiente">Ambiente para onde deve ser enviado o XML</param>
        [Theory]
        [Trait("DFe", "NFSe")]
        [MemberData(nameof(Parametros))]
        public void TesteEnvioLoteRps(TipoAmbiente tipoAmbiente, PadraoNFSe padraoNFSe, string versaoSchema, int codMunicipio)
        {
            var nomeXMLEnvio = "TesteEnvioLoteRps-env-loterps.xml";
            ...
            var configuracao = new Configuracao
            {
                ...
                Servico = Servico.NFSeTesteEnvioLoteRps,
            ...
            var testeEnvioLoteRps = new TesteEnvioLoteRps(conteudoXML, configuracao);
