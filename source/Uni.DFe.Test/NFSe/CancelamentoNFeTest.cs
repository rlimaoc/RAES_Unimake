...
{
    /// <summary>
    /// Testar o serviço: CancelamentoNfe
    /// </summary>
    public class CancelamentoNFeTest
    {
        /// <summary>
        /// Monta o parâmetros, de forma dinâmica, para o cenário de testes
        /// </summary>
        public static IEnumerable<object[]> Parametros => TestUtility.PreparaDadosCenario("CancelamentoNfe");
        ...
        public void CancelamentoNfe(TipoAmbiente tipoAmbiente, PadraoNFSe padraoNFSe, string versaoSchema, int codMunicipio)
        {
            var nomeXMLEnvio = "CancelamentoNfe-ped-cannfse.xml";
            ...
            var configuracao = new Configuracao
            {
                ...
                Servico = Servico.NFSeCancelamentoNfe,
            ...
            var cancelamentoNfe = new CancelamentoNfe(conteudoXML, configuracao);
