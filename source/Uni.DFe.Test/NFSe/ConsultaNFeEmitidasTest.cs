...
{
    /// <summary>
    /// Testar o serviço: ConsultaNFeEmitidas
    /// </summary>
    public class ConsultaNFeEmitidasTest
    {
        /// <summary>
        /// Monta o parâmetros, de forma dinâmica, para o cenário de testes
        /// </summary>
        public static IEnumerable<object[]> Parametros => TestUtility.PreparaDadosCenario("ConsultaNFeEmitidas");

        /// <summary>
        /// Consulta NFSe Emitidas para saber se a conexão com o webservice está ocorrendo corretamente.
        /// </summary>
        ...
        public void ConsultaNFeEmitidas(TipoAmbiente tipoAmbiente, PadraoNFSe padraoNFSe, string versaoSchema, int codMunicipio)
        {
            ...
            var configuracao = new Configuracao
            {
                ...
                Servico = Servico.NFSeConsultaNFeEmitidas,
