...
using Uni.Business.DFe.Servicos.CTeOS;
using Uni.Business.DFe.Xml.CTeOS;
using Xunit;

namespace Uni.DFe.Test.CTeOS
{
    /// <summary>
            ...
            var xml = new Business.DFe.Xml.CTeOS.CTeOS
            {
                ...
                InfCTe = new InfCTe
                {
                    ...
                    Emit = new Emit
                    {
                        ...
                        XFant = "EXATUS MOVEIS",
                        EnderEmit = new Uni.Business.DFe.Xml.CTeOS.EnderEmit
                        {
                    ...
                    Toma = new Toma
                    {
                        ...
                        XNome = "EXATUS MOVEIS EIRELI",
                        XFant = "EXATUS MOVEIS",
                        EnderToma = new Uni.Business.DFe.Xml.CTeOS.EnderToma
                        {
                            XLgr = "RUA JOAQUIM F. DE SOUZA",
                            Nro = "01112",
                            XBairro = "VILA TEREZINHA",
