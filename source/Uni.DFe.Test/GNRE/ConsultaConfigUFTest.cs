...
using Uni.Business.DFe.Servicos.GNRE;
using Uni.Business.DFe.Utility;
using Uni.Business.DFe.Xml.GNRE;
using Xunit;

namespace Uni.DFe.Test.GNRE
{
    /// <summary>
    ...
    public class ConsultaConfigUFTest
    {
        ...
        public void ConsultarConfigUFGNRETest(TipoAmbiente tipoAmbiente, UFBrasil uf, int receita, SimNaoLetra courier)
        {
            ...
            //Diag.Trace.WriteLine("Receita: " + receita + " Courier: " + courier.ToString() + " - Situação retorno: " + consultaConfigUF.Result.SituacaoConsulta.Codigo + "-" + consultaConfigUF.Result.SituacaoConsulta.Descricao, "Uni.DFe.Test.GNRE.ConsultarConfigUFGNRETest()");
