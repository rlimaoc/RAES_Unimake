...
namespace Uni.DFe.Test.CTe
{
    ...
    public class SerializacaoDesserializacaoTest
    {
        ...
        public void SerializacaoDesserializacaoEnviCTe(string arqXML)
        {
            ...
            var autorizacao = new Uni.Business.DFe.Servicos.CTe.Autorizacao(xml, configuracao);
        ...
        public void SerializacaoDesserializacaoCTe(string arqXML)
        {
            ...
            var xml = new Uni.Business.DFe.Xml.CTe.CTe();
            xml = xml.LerXML<Uni.Business.DFe.Xml.CTe.CTe>(doc);
            ...
            var autorizacao = new Uni.Business.DFe.Servicos.CTe.AutorizacaoSinc(xml, configuracao);
        ...
        public void SerializacaoDesserializacaoCTeOS(string arqXML)
        {
            ...
            var xml = new Uni.Business.DFe.Xml.CTeOS.CTeOS();
            xml = xml.LerXML<Uni.Business.DFe.Xml.CTeOS.CTeOS>(doc);
            ...
            var autorizacao = new Uni.Business.DFe.Servicos.CTeOS.Autorizacao(xml, configuracao);
