...
using Uni.Business.DFe.Servicos.CTe;
                        ...
                        new Business.DFe.Xml.CTe.CTe
                        {
                            InfCTe = new InfCTe
                            {
                                ...
                                Emit = new Emit
                                {
                                    ...
                                    XFant = "EXATUS MOVEIS",
                                    EnderEmit = new Uni.Business.DFe.Xml.CTe.EnderEmit
                                    {
                                ...
                                Rem = new Rem
                                {
                                    ...
                                    Fone = "04434225480",
                                    EnderReme = new Uni.Business.DFe.Xml.CTe.EnderReme
                                    {
                                ...
                                Dest = new Dest
                                {
                                    ...
                                    IE = "ISENTO",
                                    XNome = "CT-E EMITIDO EM AMBIENTE DE HOMOLOGACAO - SEM VALOR FISCAL",
                                    EnderDest = new Uni.Business.DFe.Xml.CTe.EnderDest
                                    {
