...
using Uni.Business.DFe.Servicos.MDFe;
using Uni.Business.DFe.Xml.MDFe;
using Xunit;

namespace Uni.DFe.Test.MDFe
{
    /// <summary>
    /// Testar o serviço de consulta de MDFe´s não encerrados
    /// </summary>
    public class ConsNaoEncTest
    {
        /// <summary>
        /// Consultar os MDFe´s não encerrados somente para saber se a conexão com o webservice está ocorrendo corretamente e se quem está respondendo é o webservice correto.
        ...
        public void ConsultarMDFeNaoEncerrado(UFBrasil ufBrasil, TipoAmbiente tipoAmbiente)
        {
