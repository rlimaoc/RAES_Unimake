...
namespace Uni.DFe.Test
{
    ...
    public static class PropConfig
    {
        ...
        /// </summary>
        private static string PathCertificadoDigital { get; set; } = @"C:\repositorios\git\Certificados\3050_flowtelecom.pfx";

        /// <summary>
        /// Senha de uso do certificado digital A1
        /// </summary>
        private static string SenhaCertificadoDigital { get; set; } = "3050";
