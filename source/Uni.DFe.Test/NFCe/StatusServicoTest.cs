...
namespace Uni.DFe.Test.NFCe
{
    ...
    {
        /// <summary>
        /// Consultar o status do serviço da NFCe somente para saber se a conexão com o webservice está ocorrendo corretamente e se quem está respondendo é o webservice correto.
