...
{
    /// <summary>
    /// Testar o serviço de consulta recibo da NFCe
    /// </summary>
    public class RetAutorizacaoTest
    {
        /// <summary>
        /// Consultar o recibo da NFCe somente para saber se a conexão com o webservice está ocorrendo corretamente e se quem está respondendo é o webservice correto.
