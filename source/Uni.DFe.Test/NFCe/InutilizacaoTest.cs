...
{
    /// <summary>
    /// Testar o serviço de Inutilização da NFCe
    /// </summary>
    public class InutilizacaoTest
    {
        /// <summary>
        /// Tenta inutilizar números de NFCe somente para saber se a conexão com o webservice está ocorrendo corretamente e se quem está respondendo é o webservice correto.
