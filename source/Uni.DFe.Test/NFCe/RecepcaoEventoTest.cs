...
using Uni.Business.DFe.Servicos.NFCe;
using Uni.Business.DFe.Xml.NFe;
using Xunit;

namespace Uni.DFe.Test.NFCe
{
    /// <summary>
    /// Testar o serviço de recepção de eventos da NFCe
    /// </summary>
    public class RecepcaoEventoTest
    {
        /// <summary>
        /// Enviar um evento de da NFCe somente para saber se a conexão com o webservice está ocorrendo corretamente e se quem está respondendo é o webservice correto.
