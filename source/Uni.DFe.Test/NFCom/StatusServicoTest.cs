...
{
    /// <summary>
    /// Testar o seriço de consulta do serviço SEFAZ na NFCom
    /// </summary>
    public class StatusServicoTest
    {
        /// <summary>
        /// Consultar o status do serviço da NFCom somente para saber se a conexão com o webservice está ocorrendo corretamente e se quem está respondendo é o webservice correto.
