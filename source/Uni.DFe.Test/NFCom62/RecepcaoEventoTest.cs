...
namespace Uni.DFe.Test.NFCom62
{
    ...
    {
        /// <summary>
        /// Enviar um evento de da NFCcom somente para saber se a conexão com o webservice está ocorrendo corretamente e se quem está respondendo é o webservice correto.
